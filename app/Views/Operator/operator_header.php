<nav class="sticky-top tonav ">
    <!-- <div class="margin"> -->
        ...
        <div style="float: left;width: 10%;display: flex;align-items: center;" class="marleft tonavHeight">
            <img id="smartlogo1" src="<?php echo base_url()?>/assets/img/logo.png" style="height:1.8rem;text-align:center;margin-block-start:auto;">
        </div>
        <div style="float: left;width: 15%;" class="tonavHeight centerAlign">
            <div class="box" style="width:90%;">
                <div class="input-box">      
                    <select class="form-select" id="op_machine_drp">
                        <!-- <option>MC1001</option>
                        <option>MC1002</option> -->
                    </select>
        ...
        <div style="float: left;width: 10%;height: 100%;" class="centerAlign tonavHeight">
            <div>
                ...
                <p class="paddingm" id="op_header_sdate">29 Jan 2022</p>
            </div>
        </div>
        <div style="float: left;width: 10%" class="centerAlign tonavHeight">
            <div>
                <p class="paddingm text-g">Shift</p>
                <p class="paddingm" id="op_header_sid">Shift A</p>
            </div>
        </div>
        <div style="float: left;width: 10%" class="centerAlign tonavHeight">
            <div>
                <p class="paddingm text-g">Start</p>
                <p class="paddingm" id="op_header_start_time">06:00 AM</p>
            </div>
        </div>
        ...
        <div style="float: left;width: 10%" class="centerAlign tonavHeight">
            <div>
                ...
                <p class="paddingm" id="op_header_end_time">02:00 PM</p>
            </div>
        </div>

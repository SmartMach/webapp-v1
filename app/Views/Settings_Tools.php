            ...
            res.forEach(function(item){
                ...
                if (item.status == 1) {
                    ...
                    elements = elements.add('<div id="settings_div">'
                        ...
                        +'<li class="deactivate-tool " lvalue="'+item.part_id+'" svalue="'+item.status+'" style="display:'+deactivate_machine+';"><a href="#"><img  src="<?php echo base_url('assets/img/delete.png'); ?>" class="img_font_wh1" style="margin-left:10px;">DEACTIVATE</a></li>'
                        +'</ul>'
                        +'</li>'
                        +'</ul>'               
                        +'</div>'  
                    ...
                    elements = elements.add('<div id="settings_div">'
                        ...
                        +'<li class="activate-tool active_not" lvalue="'+item.part_id+'" svalue="'+item.status+'" style="display:'+activate_machine+';"><a href="#" ><img src="<?php  echo base_url('assets/img/activate.png') ?>" class="img_font_wh2" style="margin-left:10px;"></i>ACTIVATE</a></li>'
                        +'</ul>'
                        +'</li>'
                        +'</ul>'                
                        +'</div>'

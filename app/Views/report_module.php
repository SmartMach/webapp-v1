        ...
        <div class="data_section">
            ...
            <div class="contentMachine tableDataContainer paddingm ">
                <div class="table_data">
                    <div class="row paddingm">
                        <div class="col-sm-1 col marleft table_data_section display_f align_c" ><p class="table_data_element fnt_fam">MC1001</p></div>
                        <div class="col-sm-2 col marleft table_data_section display_f align_c" ><p class="table_data_element fnt_fam" title='+item.machine_name+'>IMO1</p></div>       
                        <div class="col-sm-2 col paddingm marright table_data_section display_f justify_e align_c" >
                            <p class="paddingm h_mar_r table_data_element fnt_fam"><i class="fa fa-inr mar_right_logo" style="font-size:0.70rem;"></i>120</p>
                        </div>
                        <div class="col-sm-2 col paddingm table_data_section display_f justify_e align_c" >
                            <p class="paddingm h_mar_r table_data_element fnt_fam"><i class="fa fa-inr mar_right_logo" style="font-size:0.70rem;"></i>245</p>
                        </div>
                        <div class="col-sm-1 col marleft table_data_section display_f align_c" ><p class="table_data_element fnt_fam">123T</p></div>
                        <div class="col-sm-2 col marleft table_data_section display_f align_c" ><p class="table_data_element fnt_fam">DOSIBA</p></div>

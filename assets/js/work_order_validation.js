...
$(document).on('click','#add_issue_button',function(event){
        ...
        $('#priority_val_lable').text('Select');
...
$('.edit-work-order').on('click',function(){
    console.log('edit_wordorderedit');
